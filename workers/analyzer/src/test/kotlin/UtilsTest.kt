...
class UtilsTest : WordSpec({
    "getIdentifierToShortestPathMap()" should {
        "extract the shortest of the shortest paths for each identifier" {
            val projectsToShortestPathsByScope: Map<OrtProject, Map<String, Map<OrtIdentifier, List<OrtIdentifier>>>> =
                mapOf(
                    OrtProject(
                        id = OrtIdentifier("NPM", "com.example", "example", "1.0"),
                        definitionFilePath = "",
                        ...
                        scopeNames = setOf("dependencies", "devDependencies")
                    ) to mapOf(
                    ...
                    OrtProject(
                        id = OrtIdentifier("NPM", "com.example", "example2", "1.0"),
                        definitionFilePath = "",
                        declaredLicenses = emptySet(),
                        vcs = OrtVcsInfo(
                            VcsType.GIT,
                            "https://example2.com/git",
                            "revision",
                            "path"
                        ),
            ...
            val identifierToShortestPathMap = getIdentifierToShortestPathMap(projectsToShortestPathsByScope)
            ...
            shortestPath2.shouldNotBeNull {
                ...
                project.identifier shouldBe Identifier("NPM", "com.example", "example2", "1.0")
            }
        }
    }
})
