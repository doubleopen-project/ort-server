...
class PackageServiceTest : WordSpec() {
    ...
    init {
        ...
        "listForOrtRunId" should {
            ...
            "return the shortest dependency path for packages" {
                val service = PackageService(db)
                ...
                with(results.data.first()) {
                    ...
                    shortestDependencyPath shouldBe ShortestDependencyPath(
                        project,
                        "compileClassPath",
                        listOf(identifier1)
                    )
    ...
    private fun createAnalyzerRunWithPackages(
        ...
        shortestPaths: Map<Identifier, ShortestDependencyPath> = emptyMap()
    ): OrtRun {
