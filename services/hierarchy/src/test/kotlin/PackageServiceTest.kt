    ...
    init {
        ...
        "listForOrtRunId" should {
            ...
            "limit and sort the result based on query options" {
                ...
                val ortRunId = createAnalyzerRunWithPackages(
                    setOf(
                        createPackage(Identifier("Maven", "com.example", "example", "1.0")),
                        createPackage(Identifier("Maven", "com.example", "example2", "1.0")),
                        createPackage(Identifier("Maven", "com.example", "example3", "1.0"))
                    )
                ).id
        ...
        "countForOrtRunId" should {
            "return count for packages found in an ORT run" {
                ...
                val ortRunId = createAnalyzerRunWithPackages(
                    setOf(
                        createPackage(Identifier("Maven", "com.example", "example", "1.0")),
                        createPackage(Identifier("NPM", "com.example", "example2", "1.0"))
                    )
                ).id
