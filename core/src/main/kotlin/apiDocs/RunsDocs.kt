...
val getPackagesByRunId: OpenApiRoute.() -> Unit = {
    ...
    request {
        ...
        queryParameter<String>("identifier") {
            description = "Defines an ORT package identifier for which the packages are to be retrieved for. This " +
                    "uses a case insensitive substring match."
        }

        queryParameter<String>("purl") {
            description = "Defines a purl for which the packages are to be retrieved for. This uses a case " +
