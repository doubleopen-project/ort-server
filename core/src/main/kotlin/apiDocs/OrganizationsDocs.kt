...
val getVulnerabilitiesByOrganizationId: OpenApiRoute.() -> Unit = {
    operationId = "GetVulnerabilitiesByOrganizationId"
    summary = "Get the vulnerabilities from latest successful advisor runs across the repositories in the products " +
            "of an organization."
    tags = listOf("Organizations", "Vulnerabilities")
