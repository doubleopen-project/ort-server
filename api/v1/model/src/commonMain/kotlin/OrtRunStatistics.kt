...
data class OrtRunStatistics(
    ...
    val issuesCountBySeverityTotal: Map<Severity, Long>? = null,
    ...
    val vulnerabilitiesCountByRatingTotal: Map<VulnerabilityRating, Long>? = null,
    ...
    val ruleViolationsCountBySeverityTotal: Map<Severity, Long>? = null
)
